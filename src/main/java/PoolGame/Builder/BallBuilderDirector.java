...
public class BallBuilderDirector {
    ...
    public void registerDefault() {
        ...
        this.register("brown", new BrownBallBuilder(BallType.NORMALBALL, new PocketThree()));
        this.register("black", new BlackBallBuilder(BallType.NORMALBALL, new PocketThree()));
    }
